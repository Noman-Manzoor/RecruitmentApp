...
namespace Infrastructure.UnitOfWork
{
    ...
    public class UnitOfWork : IUnitOfWork
    {
        ...
        /// Context declare
        /// </summary>
        private readonly DMRecruitmentContext context;
        ...
        public UnitOfWork(DbContextOptions<DMRecruitmentContext> options)
        {
            this.context = new DMRecruitmentContext(options);
        ...
        public IRepository<T> Repository<T>() where T : class
        {
            ...
            {
                Type repositoryType = typeof(Infrastructure.GenericRepository.Repository<>);
